...
- [`align_distributions()`](https://kabilanbio.github.io/scSimEval/reference/align_distributions.md)
...
- [`evaluate_benchmark`](https://kabilanbio.github.io/scSimEval/reference/evaluate_benchmark.md)
  : Master Evaluation Pipeline for Single-Cell and Multiomics Simulation
  Benchmarking
...
- [`extract_properties`](https://kabilanbio.github.io/scSimEval/reference/extract_properties.md)
  : Extraction of Single-Cell and Multiomics Summary Properties
- [`hungarian_match()`](https://kabilanbio.github.io/scSimEval/reference/hungarian_match.md)
...
- [`metrics_batch`](https://kabilanbio.github.io/scSimEval/reference/metrics_batch.md)
  : Batch Effect & Integration Evaluation Metrics
- [`metrics_clustering`](https://kabilanbio.github.io/scSimEval/reference/metrics_clustering.md)
  : Cell Clustering and Population Separation Metrics
- [`metrics_de_signal`](https://kabilanbio.github.io/scSimEval/reference/metrics_de_signal.md)
  : Differential Features and Biological Signal Evaluation
- [`metrics_distribution`](https://kabilanbio.github.io/scSimEval/reference/metrics_distribution.md)
  : Statistical Distribution & Distance Metrics
- [`metrics_scalability`](https://kabilanbio.github.io/scSimEval/reference/metrics_scalability.md)
  : Computational Performance & Scalability Metrics
- [`metrics_trajectory`](https://kabilanbio.github.io/scSimEval/reference/metrics_trajectory.md)
  : Trajectory & Differentiation Lineage Dynamics
- [`multiomics_coupling`](https://kabilanbio.github.io/scSimEval/reference/multiomics_coupling.md)
  : Single-Cell Multiomics Cross-Modality Coupling
...
- [`plot_benchmark_summary()`](https://kabilanbio.github.io/scSimEval/reference/plot_benchmark_summary.md)
...
- [`to_pseudobulk()`](https://kabilanbio.github.io/scSimEval/reference/to_pseudobulk.md)
  : Convert Single-Cell Counts to Replicate Pseudobulks
- [`utils`](https://kabilanbio.github.io/scSimEval/reference/utils.md) :
  Core Utilities and Alignment Functions
- [`visualizations`](https://kabilanbio.github.io/scSimEval/reference/visualizations.md)
  : Scientific Visualization Suite for Single-Cell Multiomics Simulation
  Benchmarking
