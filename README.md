...
The package is developed specifically for:
...
> **Note on Data Types:** `scSimEval` has been primarily developed and validated for scRNA-seq, scATAC-seq, and paired scRNA-seq + scATAC-seq multiomics. Other single-cell omics data types (such as CITE-seq surface protein or single-cell methylation) have not been tested yet.
