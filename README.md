...
- **Embedded Interactive Shiny Studio GUI:** Interactive graphical interface to explore benchmark results and export 600 DPI figures without coding.
...
For researchers who prefer an interactive visual interface rather than writing code, `scSimEval` includes an embedded **Interactive Shiny App GUI**. This web application enables you to explore benchmarking results across all 62 metrics, customize category weights, inspect comparative distribution QC plots, and export publication-ready figures (at 600 DPI) directly from your browser:
